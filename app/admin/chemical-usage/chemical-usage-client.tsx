...
export default function ChemicalUsageClient() {
  ...
  }, [from, to, selectedStation, selectedArea, selectedChemical, toast]);
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-4">Chemical Usage Insights</h1>
